...
function CryptoDetails() {
  ...
  const { data: coinHistory } = useGetCryptoPriceHistoryQuery({
    timePeriod,
    coinId,
  });
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <Text>An overview showing stats of the {cryptoDetails.name}</Text>
          </Col>
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <Text>Market, availability and circulation stats</Text>
          </Col>
